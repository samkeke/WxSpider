...
// 数据库配置
db::set_connect('default', $GLOBALS['config']['SPIDER_DB']);
// 数据库链接
db::_init();
log::$log_file = __DIR__.'/../../../data/runtime/Logs/phpspider.log';
    /**
 * PHP将网页上的图片攫取到本地存储
 ...
 * @return mix
 */
function crabImage($imgUrl, $saveDir = './')
{
    if (empty($imgUrl)) {
        return false;
    }
...
//$test_url = "https://mp.weixin.qq.com/s?__biz=MjM5MzA4NTc2MA==&mid=2678373147&idx=1&sn=34bb68c724ce508dd8b8ca45ca744640&chksm=bccc7b348bbbf22240d7bc3a2114c6d7ed852a89da6ddcfd00e72c89caa9254b7a5f8643f3cd#rd";
//$GLOBALS['url'] = [$test_url];
//$GLOBALS['config']['SPIDER']['scan_urls'] = [$test_url];
//$GLOBALS['config']['SPIDER']['list_url_regexes'] = [$test_url];
